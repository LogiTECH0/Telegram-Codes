...
public class Phone extends Frame {
    ...
    private void openNewWindow() {
        ...
        TextField version = new TextField("POCO X3 Pro");
        ...
        newYorkTime.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Timer newYorkTimer = new Timer();
                newYorkTimer.scheduleAtFixedRate(new TimerTask() {
                    public void run() {
                        updateTimeForCity("America/New_York", newTimeTextField);
                    }
                }, 0, 1000);
            }
        });
        kievTime.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Timer kievTimer = new Timer();
                kievTimer.scheduleAtFixedRate(new TimerTask() {
                    public void run() {
                        updateTimeForCity("Europe/Kiev", newTimeTextField);
                    }
                }, 0, 1000);
            }
        });
    ...
    private void updateTimeForCity(String timeZoneId, TextField timeTextField) {
